      ...
      >
        ...
        <div class="relative bg-white rounded-xl shadow-2xl w-full max-w-md p-6 space-y-5">
          ...
          <div class="text-center space-y-2">
            ...
            <p class="text-sm text-gray-500">
              ...
              <span class="font-semibold text-gray-800">
                &laquo;&nbsp;{{ zoneName }}&nbsp;&raquo;
              </span>&nbsp;?
            </p>
            <p class="text-xs text-red-500 font-medium">
              Cette action est irréversible. Les incidents liés à cette zone seront affectés.
            </p>
          </div>
          ...
          <div class="flex gap-3 pt-1">
            <button
              class="flex-1 px-4 py-2 border border-gray-200 rounded-lg text-sm text-gray-600 hover:border-gray-300 transition-colors disabled:opacity-50"
              :disabled="loading"
              @click="handleCancel"
            >
              Annuler
